...
- Code packages (`@lucas-contrial/core`, `@lucas-contrial/cli`, `@lucas-contrial/mcp`) follow their own SemVer but pin the spec version they implement in their README
